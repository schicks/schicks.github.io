...
<script>
  import VegaLite from '../../components/VegaLite.svelte'; //
  https://github.com/pngwn/MDsveX/issues/76 // problems in mdsvex make katex processing a bear. //
  defining n avoids a parse error, but n is never used. const n = null;
</script>
